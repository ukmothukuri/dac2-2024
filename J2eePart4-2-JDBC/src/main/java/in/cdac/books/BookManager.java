...
//		
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			DBOperations dob = new DBOperations();
			int result = dob.addBookDetails(bk);
			if(result == 1) {
				msg = "Book has been added successfully";
				//out.print("Book has been added successfully");
			}else {
				msg = "Unable to add the book details. Please try after sometime.";
			//	out.print("Unable to add the book details. Please try after sometime.");
			}
